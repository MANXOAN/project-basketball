...
export default function MapPage() {
  ...
  return <div className="min-h-screen bg-[#f7f8f6] px-4 py-8 text-slate-900 sm:py-12"><div className="mx-auto max-w-7xl">
    <header className="mb-6 flex flex-col justify-between gap-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:flex-row md:items-end md:p-8"><div><p className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-amber-600"><Sparkles className="h-4 w-4" /> Khám phá theo vị trí</p><h1 className="mt-2 text-3xl font-extrabold tracking-tight text-slate-950 md:text-4xl">Bản đồ sân bóng rổ</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">Chọn khu vực để Google Maps tìm các sân bóng rổ phù hợp trực tiếp trên bản đồ.</p></div><Link to="/fields" className="btn-outline inline-flex min-h-11 items-center justify-center rounded-xl px-5 text-sm font-bold">Xem danh sách sân</Link></header>
